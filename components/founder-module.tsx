...
export function FounderModule({ dict }: FounderModuleProps) {
  return (
    <div className="flex flex-col bg-[var(--bg-surface)] border border-[var(--border-subtle)] md:col-span-5 lg:col-span-4 mt-8 md:mt-16">
      ...
      {/* Retrato / Fotografia */}
      <div className="relative w-full aspect-[3/4] md:aspect-[4/5] bg-[var(--bg-base)] flex items-center justify-center overflow-hidden">
