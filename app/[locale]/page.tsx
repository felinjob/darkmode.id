  ...
  return (
    <>
      ...
      <main className="flex flex-col w-full">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-6 px-4 md:px-8 lg:px-12 xl:px-16 pt-12 md:pt-24 pb-16 md:pb-32 border-b border-[var(--border-subtle)]">
